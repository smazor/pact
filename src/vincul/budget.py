"""
vincul.budget — Budget ledger: parallel state for budget tracking
...
Implements BudgetLedgerProtocol from vincul.interfaces.
...
from vincul.hashing import normalize_ledger_balances
from vincul.types import FailureCode, UUID, ValidationResult
...
class BudgetLedger:
    ...
    Satisfies BudgetLedgerProtocol from vincul.interfaces.
    """
