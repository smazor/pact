"""
vincul.validator — Unified enforcement boundary
...
Depends on: vincul.interfaces, vincul.types
...
from vincul.interfaces import (
    BudgetLedgerProtocol,
    ConstraintEvaluatorProtocol,
    ContractStoreProtocol,
    ScopeStoreProtocol,
)
from vincul.types import FailureCode, OperationType, UUID, ValidationResult
