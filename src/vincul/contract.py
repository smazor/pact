"""
vincul.contract — Coalition Contract schema, lifecycle, governance, and store
...
from vincul.hashing import normalize_contract, vincul_hash
...
class CoalitionContract:
    ...
    by ci/check_vectors.py and vincul.hashing.normalize_contract().
    ...
    def compute_hash(self) -> Hash:
        return vincul_hash("contract", self.normalize())
...
class ContractStore:
    ...
    Satisfies ContractStoreProtocol from vincul.interfaces.
    """
