# Vincul Protocol — Compliance Profiles
...
Vincul's core protocol specs define invariants that all conformant implementations must satisfy. Some properties, however, are not fixed by the protocol — they are *bounded* by the protocol and *declared* by implementations.
...
ComplianceProfile:
  ...
  protocol_version: string         # the Vincul protocol version this profile conforms to; e.g. "0.2"
  implementation:
